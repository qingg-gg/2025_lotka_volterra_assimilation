...
%   (3) alpha_amplitude = delta_z * (r + gamma_z) / beta_z, r = ln(R0) / (T * 12)
%   (4) R0 = 每年胎數 * 每胎數量 * 幼體存活率 * 平均壽命 -> 設五年一胎、存活率 50%、平均壽命 25 年
%   (5) T = 性成熟歲數 + 平均壽命 / 2 -> 設性成熟歲數 5 歲
% ===================================================================================== %

function alpha = growth_rate_bear(t, beta_z, delta_z, gamma_z)

alpha_base = 0.1;
alpha_amplitude = delta_z * (0.008 + gamma_z) / beta_z; % 增長率變動幅度 -> 設每胎數量 2 隻
