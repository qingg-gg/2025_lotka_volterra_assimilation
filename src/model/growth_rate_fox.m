...
%   (3) alpha_amplitude = delta_y * (r + gamma_y) / beta_y
%   (4) R0 = 每年胎數 * 每胎數量 * 幼體存活率 * 平均壽命 -> 設一年一胎、存活率 20%、平均壽命 4.5 年
%   (5) T = 性成熟歲數 + 平均壽命 / 2 -> 設性成熟歲數 0.8 歲
% ====================================================================================== %

function alpha = growth_rate_fox(t, beta_y, delta_y, gamma_y)

alpha_base = 0.04;                                      % 最低增長率 -> 設每胎數量 2 隻
alpha_amplitude = delta_y * (0.04 + gamma_y) / beta_y;  % 增長率變動幅度 -> 設每胎數量 5 隻
